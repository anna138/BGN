...
int main(){
        ...
        */
        ...
        std::cout << std::endl << "Multiplying "<< var1 <<" and " << var2  << std::endl; 
	std::cout << "The result is: "<< String(pt3) << std::endl; 
	std::cout << "We are able to see the result of multiplication here because we decrypted inside the multiply function to avoid segfault\n" << std::endl;
        ...
        //EMult(ct, ct2, &pk, ct4);
        printf("SAME LINE Main this Ciphertext's Degree L54: %d \n", ct3.Degree);
	std::cout << "This is where the problem lies. I can access the ciphertext's degree value, but once I try to print out the coefficient's of my ciphertext value to decrypt it will segfault" << std::endl;
        element_printf("Main this L56 this Ciphertext's Coefficient: %B \n",ct3.Coefficients[0]);
